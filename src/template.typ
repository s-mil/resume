...
/* Styling */
#let headerFont = ("Source Sans 3", "Symbols Nerd Font")
#let textFont = ("Source Sans 3", "Symbols Nerd Font")

#let textColors = (
    lightGray: rgb("#eff1f5"),
    mediumGray: rgb("#8c8fa1"),
    darkGray: rgb("#4c4f69"),
)
...
#let cvEntry(
    ...
    let ifOrganizationFirst(condition, field1, field2) = {
    ...
    table(
        ...
        table(
            ...
            row-gutter: 8pt,
            align: auto,
            {entryA1Style(ifOrganizationFirst(varEntryOrganizationFirst, organization, title))},
            {entryA2Style(date)},
            {entryB1Style(ifOrganizationFirst(varEntryOrganizationFirst, title, organization))},

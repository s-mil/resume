...
#cvEntry(
  ...
  description: [
    ...
    - Tested Microsoft's defender for Containers to help Chevron Management make an informed decision about switching to it or keep Palo Alto Network's Prisma Cloud Compute suite, allowing for a savings of 3 MM per year to be executed with confidence.

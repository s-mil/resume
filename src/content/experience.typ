...
#cvEntry(
  ...
  description: [
    - Implemented a unified Azure Policy management dashboard that streamlines Cost Optimization and Exception handling.

    - Key Subject Matter Expert in rolling out core Azure Kubernetes CIS security policies, writing out technical documentation and hands on assistance for core applications allowing for a bold timeline of 3 months from announcement to enforcement with 100% compliance

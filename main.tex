...
\begin{cv}{\spacedallcaps{Sam Miller}}\vspace{1.5em} % Your name

    \noindent\spacedlowsmallcaps{Personal Information}\vspace{0.5em} % Personal information heading

    \NewEntry{email}{\href{mailto:sam@sammiller.dev}{sam@sammiller.dev}} % Email address

    \NewEntry{github}{\href{https://www.github.com/s-mil}{https://www.github.com/s-mil}} % Personal website

    \NewEntry{phone}{(M) +1 (979) 571 0513}
    ...
    \NewEntry{2019--Present}{1\textsuperscript{st} Year Analyst, \textsc{Lehman Brothers}}
